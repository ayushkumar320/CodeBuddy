# CodeBuddy — Live test checklist (before publishing v2.1)
...
npm audit --omit=dev     # ✅ 0 vulnerabilities
 npm pack --dry-run       # ✅ lists dist/, migrations, README, examples; version 2.1.0
```
...
```bash
npm run build
npm pack                                        # → ayushkumar320-codebuddy-2.1.0.tgz
npm install -g ./ayushkumar320-codebuddy-2.1.0.tgz
codebuddy --version                             # PASS: prints 2.1.0
...
rm -f ayushkumar320-codebuddy-2.1.0.tgz
```
